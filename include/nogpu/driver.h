...
enum class GPUDriverFeature : int {
    ...
    DRIVER_COMPRESSED_SIMPLE,
    DRIVER_COMPRESSED_RGTC,
    DRIVER_COMPRESSED_DXTC,
    DRIVER_COMPRESSED_BC7,
    DRIVER_COMPRESSED_ETC1,
    DRIVER_COMPRESSED_ETC2,
    DRIVER_COMPRESSED_ASTC,
