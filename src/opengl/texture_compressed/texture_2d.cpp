...
void GLCompressed2D::upload(int x, int y, int w, int h, int level, void* data) {
    m_ctx->gl__makeCurrent();
...
void GLCompressed2D::unpack(int x, int y, int w, int h, int level, GPUBuffer *pbo, int offset) {
    m_ctx->gl__makeCurrent();
